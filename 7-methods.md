...
UAS-NPFR-RD, UAS-NPFR-RB were generated by the author by cloning NPFR cDNA from the Drosophila heads, sub-cloning the cDNAs in the pUAS-T attB vectors, injecting the plasmids in the attP flies (BDSC #9736) for site-specific integration of the cDNA.
