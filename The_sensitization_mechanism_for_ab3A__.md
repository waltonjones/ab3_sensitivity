...
However, the quantification result by using qPCR, shows that there is no difference in the level of mRNA of OR22a between NPFR mutants and its genetic control flies (Fig 3-A). 
